...
class HelpSupportScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: Color(0xFF46C2AF), // Updated color
        centerTitle: true,
        elevation: 0,
      ),
      body: Container(
        color: Color(0xFFF5F5F5), // Light grey for a calm background
  ...
  Widget _buildContactItem({required IconData icon, required String title, required String content}) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(icon, size: 30, color: Color(0xFF46C2AF)), // Updated color
          SizedBox(width: 20),
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
